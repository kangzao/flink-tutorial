package com.jep.flink.tutorial.aggregate;
...
//        SingleOutputStreamOperator<WaterSensor> result = sensorKS.sum(2);  这行代码会报错
//        SingleOutputStreamOperator<WaterSensor> result1 = sensorKS.sum("vc");
//        先按照id分组然后求和
//        result1.print();
